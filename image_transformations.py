...
def transform(im, T):
    ...
    im_new = cv2.warpAffine(im, T[:2], (Width, Height))
                
    return im_new
def transformPerspective(im, T):
    Height, Width, _ = im.shape
    im_new = cv2.warpPerspective(im, T, (Width, Height))
...
if __name__ == '__main__':
    ...
    filename = 'Assignment1/data/000006-color.jpg'
    ...
    print(T5)
    im_5 = transformPerspective(im, T5)
